...
<footer class="landing-footer bg-body footer-text">
      <div class="footer-top position-relative overflow-hidden z-1">
        <img
          src="<?php echo base_url()?>assets/img/front-pages/backgrounds/footer-bg.png"
          alt="footer bg"
          ...
          <div class="row gx-0 gy-6 g-lg-10">
            ...
            <div class="col-lg-3 col-md-4">
              ...
              <a href="javascript:void(0);" class="d-block mb-4"
                ><img src="<?php echo base_url()?>assets/img/front-pages/landing-page/apple-icon.png" alt="apple icon"
              /></a>
              <a href="javascript:void(0);" class="d-block"
                ><img src="<?php echo base_url()?>assets/img/front-pages/landing-page/google-play-icon.png" alt="google play icon"
              /></a>
            </div>
          </div>
        </div>
