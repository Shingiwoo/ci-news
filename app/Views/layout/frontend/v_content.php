...
<div data-bs-spy="scroll" class="scrollspy-example">
  ...
  <section id="hero-animation">
    <div id="landingHero" class="section-py landing-hero position-relative">
      <img src="<?php echo base_url()?>assets/img/front-pages/backgrounds/hero-bg.png" alt="hero background"
        ...
        <div id="heroDashboardAnimation" class="hero-animation-img">
          <a href="../vertical-menu-template/app-ecommerce-dashboard.html" target="_blank">
            <div id="heroAnimationImg" class="position-relative hero-dashboard-img">
              <img src="<?php echo base_url()?>assets/img/front-pages/landing-page/hero-dashboard-light.png"
                alt="hero dashboard" class="animation-img"
                data-app-light-img="front-pages/landing-page/hero-dashboard-light.png"
                data-app-dark-img="front-pages/landing-page/hero-dashboard-dark.png" />
              <img src="<?php echo base_url()?>assets/img/front-pages/landing-page/hero-elements-light.png"
    ...
    <div class="container">
      ...
      <h4 class="text-center mb-1">
        <span class="position-relative fw-extrabold z-1">Everything you need
          <img src="<?php echo base_url()?>assets/img/front-pages/icons/section-title-icon.png" alt="laptop charging"
        ...
        <div class="col-md-6 col-lg-5 col-xl-3">
          ...
          <h4 class="mb-1">
            <span class="position-relative fw-extrabold z-1">What people say
              <img src="<?php echo base_url()?>assets/img/front-pages/icons/section-title-icon.png"
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="card h-100">
                    <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                      <div class="mb-4">
                        <img src="<?php echo base_url()?>assets/img/front-pages/branding/logo-1.png" alt="client logo"
                ...
                <div class="swiper-slide">
                  <div class="card h-100">
                    <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                      <div class="mb-4">
                        <img src="<?php echo base_url()?>assets/img/front-pages/branding/logo-2.png" alt="client logo"
                          class="client-logo img-fluid" />
                      </div>
                      <p>
                      ...
                      <div class="d-flex align-items-center">
                        <div class="avatar me-3 avatar-sm">
                          <img src="<?php echo base_url()?>assets/img/avatars/2.png" alt="Avatar"
                            class="rounded-circle" />
                        </div>
                        <div>
                ...
                <div class="swiper-slide">
                  <div class="card h-100">
                    <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                      <div class="mb-4">
                        <img src="<?php echo base_url()?>assets/img/front-pages/branding/logo-3.png" alt="client logo"
                          class="client-logo img-fluid" />
                      </div>
                      <p>
                ...
                <div class="swiper-slide">
                  <div class="card h-100">
                    <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                      <div class="mb-4">
                        <img src="<?php echo base_url()?>assets/img/front-pages/branding/logo-4.png" alt="client logo"
                          class="client-logo img-fluid" />
                      </div>
                      <p>
                ...
                <div class="swiper-slide">
                  <div class="card h-100">
                    <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                      <div class="mb-4">
                        <img src="<?php echo base_url()?>assets/img/front-pages/branding/logo-5.png" alt="client logo"
                          class="client-logo img-fluid" />
                      </div>
                      <p>
                        “I've never used a theme as versatile and flexible as Vuexy. It's my go to for building
                ...
                <div class="swiper-slide">
                  <div class="card h-100">
                    <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                      <div class="mb-4">
                        <img src="<?php echo base_url()?>assets/img/front-pages/branding/logo-6.png" alt="client logo"
                          class="client-logo img-fluid" />
                      </div>
                      <p>
    ...
    <div class="container">
      <div class="swiper-logo-carousel pt-8">
        <div class="swiper" id="swiper-clients-logos">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img src="<?php echo base_url()?>assets/img/front-pages/branding/logo_1-light.png" alt="client logo"
            ...
            <div class="swiper-slide">
              <img src="<?php echo base_url()?>assets/img/front-pages/branding/logo_2-light.png" alt="client logo"
            ...
            <div class="swiper-slide">
              <img src="<?php echo base_url()?>assets/img/front-pages/branding/logo_3-light.png" alt="client logo"
            ...
            <div class="swiper-slide">
              <img src="<?php echo base_url()?>assets/img/front-pages/branding/logo_4-light.png" alt="client logo"
            ...
            <div class="swiper-slide">
              <img src="<?php echo base_url()?>assets/img/front-pages/branding/logo_5-light.png" alt="client logo"
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="card mt-3 mt-lg-0 shadow-none">
            <div class="bg-label-primary border border-bottom-0 border-label-primary position-relative team-image-box">
              <img src="<?php echo base_url()?>assets/img/front-pages/landing-page/team-member-1.png"
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="card mt-3 mt-lg-0 shadow-none">
            <div class="bg-label-info border border-bottom-0 border-label-info position-relative team-image-box">
              <img src="<?php echo base_url()?>assets/img/front-pages/landing-page/team-member-2.png"
                class="position-absolute card-img-position bottom-0 start-50" alt="human image" />
            </div>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="card mt-3 mt-lg-0 shadow-none">
            <div class="bg-label-danger border border-bottom-0 border-label-danger position-relative team-image-box">
              <img src="<?php echo base_url()?>assets/img/front-pages/landing-page/team-member-3.png"
                class="position-absolute card-img-position bottom-0 start-50" alt="human image" />
            </div>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="card mt-3 mt-lg-0 shadow-none">
            <div class="bg-label-success border border-bottom-0 border-label-success position-relative team-image-box">
              <img src="<?php echo base_url()?>assets/img/front-pages/landing-page/team-member-4.png"
                class="position-absolute card-img-position bottom-0 start-50" alt="human image" />
            </div>
      ...
      <div class="text-center mb-12">
        <div class="position-relative d-inline-block pt-3 pt-md-0">
          ...
          <div class="pricing-plans-item position-absolute d-flex">
            <img src="<?php echo base_url()?>assets/img/front-pages/icons/pricing-plans-arrow.png"
      ...
      <div class="row g-6 pt-lg-5">
          ...
          <div class="card">
            <div class="card-header">
              <div class="text-center">
                <img src="<?php echo base_url()?>assets/img/front-pages/icons/paper-airplane.png"
        ...
        <div class="col-xl-4 col-lg-6">
          <div class="card border border-primary shadow-xl">
            <div class="card-header">
              <div class="text-center">
                <img src="<?php echo base_url()?>assets/img/front-pages/icons/plane.png" alt="plane icon"
                  class="mb-8 pb-2" />
        ...
        <div class="col-xl-4 col-lg-6">
          <div class="card">
            <div class="card-header">
              <div class="text-center">
                <img src="<?php echo base_url()?>assets/img/front-pages/icons/shuttle-rocket.png"
  ...
  <section id="landingFAQ" class="section-py bg-body landing-faq">
    <div class="container">
      ...
      <div class="row gy-12 align-items-center">
        <div class="col-lg-5">
          <div class="text-center">
            <img src="<?php echo base_url()?>assets/img/front-pages/landing-page/faq-boy-with-logos.png"
  ...
  <section id="landingCTA" class="section-py landing-cta position-relative p-lg-0 pb-0">
    <img src="<?php echo base_url()?>assets/img/front-pages/backgrounds/cta-bg-light.png"
    ...
    <div class="container">
      <div class="row align-items-center gy-12">
        ...
        <div class="col-lg-6 pt-lg-12 text-center text-lg-end">
          <img src="<?php echo base_url()?>assets/img/front-pages/landing-page/cta-dashboard.png" alt="cta dashboard"
      ...
      <div class="row g-6">
        <div class="col-lg-5">
          <div class="contact-img-box position-relative border p-2 h-100">
            <img src="<?php echo base_url()?>assets/img/front-pages/icons/contact-border.png" alt="contact border"
              class="contact-border-img position-absolute d-none d-lg-block scaleX-n1-rtl" />
            <img src="<?php echo base_url()?>assets/img/front-pages/landing-page/contact-customer-service.png"
